        ...
        if (this.state.serverproblem === true) {
                ...
                <div className='home-body'>
                    <div className='searchbar-container'>
                        <form className='searchbar' onSubmit={this.onFormSubmit}>
                            <input placeholder='Search Shows' onChange={this.onInputChange} value={this.state.searchterm} />
                        </form>
                    </div>
                    <div id='notfound'>Show Not Found</div>
                </div>
            )
        }
            ...
            return (
                <div className='home-body'>
                    ...
                    <div id='searchfor'>Search For Shows!</div>
                </div>
